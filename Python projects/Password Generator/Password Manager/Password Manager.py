...
Lines 89 and 91 require debugging. Program breaks if non-numbers are entered.
Line 151 and 152 same as above. Delete this line and last when done.
'''
...
import datetime
#CSV file will be written to store Titles usernames and passwords.
import csv
#OS is imported to check if a CSV file already exists in the directory to store passwords.
import os
...
def password_manager():
    print("--------------------------------------------------------")
    print("Read the following options before continuing:")
    print("'1' --- Add new accounts or Delete accounts.")
    print("'2' --- View All acounts on file.")
    print("'b' --- Go back to the previous menu.")
    while True:
        user_input1 = input("Your Response:   ")
        if user_input1 == "1":
            add_delete_acc()
        elif user_input1 == "2":
            csv_read()
